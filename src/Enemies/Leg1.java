...
public class Leg1 extends Enemy {
    ...
    public Leg1(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y,
        new SpriteSheet(ImageLoader.load("Leg1.png"), 16, 16), "WALK_RIGHT");
