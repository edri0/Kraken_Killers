...
public class Leg2 extends Enemy {
    ...
    public Leg2(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y,
        new SpriteSheet(ImageLoader.load("Leg2.png"), 32, 32), "WALK_RIGHT");
