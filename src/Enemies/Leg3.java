...
public class Leg3 extends Enemy {
    ...
    public Leg3(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y,
        new SpriteSheet(ImageLoader.load("Leg3.png"), 32, 32), "WALK_RIGHT");
    ...
    public HashMap<String, Frame[]> loadAnimations(SpriteSheet sheet) {
        return new HashMap<String, Frame[]>() {{
            ...
            put("HURT_RIGHT", new Frame[]{
                    new FrameBuilder(sheet.getSprite(0, 1), 5).withScale(3).withBounds(4,2,32,32).build(),
                    new FrameBuilder(sheet.getSprite(1, 1), 5).withScale(3).withBounds(4,2,32,32).build(),
                    new FrameBuilder(sheet.getSprite(2, 1), 5).withScale(3).withBounds(4,2,32,32).build()
            });

            put("HURT_LEFT", new Frame[]{
                    new FrameBuilder(sheet.getSprite(0, 1), 5).withScale(3).withBounds(4,2,32,32).withImageEffect(ImageEffect.FLIP_HORIZONTAL).build(),
                    new FrameBuilder(sheet.getSprite(1, 1), 5).withScale(3).withBounds(4,2,32,32).withImageEffect(ImageEffect.FLIP_HORIZONTAL).build(),
                    new FrameBuilder(sheet.getSprite(2, 1), 5).withScale(3).withBounds(4,2,32,32).withImageEffect(ImageEffect.FLIP_HORIZONTAL).build()
            });
        }};
    }
